                ...
                <div class="card-body text-left">
                    ...
                    <form method="POST" action="{{ route('employees.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter a Student name " id="name" name="name"
                                required />
                        </div>
                        <div class="form-group">
                            <label for="position">Position <i>{without any space}</i></label>
                            <input type="text" class="form-control" placeholder="Enter Student Position " id="position" name="position"
                                required />
                        </div>
